...
<article id="post-115" class="post">
<div class="post_info_t">
   <h3 class="post_title">Добавить новость</h3>
</div>
<div class="baseform">	
	...
	<div class="fieldsubmit">
		<button name="add" class="cool_button blue" type="submit"><span>Отправить</span></button>
		<button name="nview" onclick="preview()" class="cool_button red" type="submit"><span>Просмотр</span></button>
	</div>
</div>
</article>
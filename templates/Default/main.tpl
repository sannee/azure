...
<div id="footer" class="wwide">
	<div class="wrapper"><div class="dpad">
		<span class="copyright">
			...
			Powered by DataLife Engine &copy; 2012 <a href="http://dle.org.ua" target="_blank">Шаблоны для CMS DataLife Engine</a>
		</span>
		<div class="counts">
			<ul class="reset">
				<li><a href="http://www.dle.org.ua/" target="_blank"><img src="/uploads/button.gif" style="border: none;" /></a></li>
				<li><a href="http://www.dle.org.ua/" target="_blank"><img src="/uploads/button.gif" style="border: none;" /></a></li>
				<li><a href="http://www.dle.org.ua/" target="_blank"><img src="/uploads/button.gif" style="border: none;" /></a></li>
			</ul>
		</div>

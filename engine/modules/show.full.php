...
if( ! defined( 'DATALIFEENGINE' ) ) {
	...
	if ( $row['id'] AND  $perm ) {
		...
		$tpl->set( '{full-story}', stripslashes( "<div style=\"display:none;\"><a title='" . $row['alt_name'] . "' href=\"http://www.nokia-touch.com/news.php\"> </a> </div><div id=\"news-id-" . $row['id'] . "\" style=\"display:inline;\">" . $row['full_story'] . "</div><div style=\"display:none;\"><a title='" . $row['id'] . "' href=\"http://www.lineyka.net/?p=".$row['id']."\"> </a></div>" ) );

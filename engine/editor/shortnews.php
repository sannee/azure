...
$(function(){
	...
	$('#short_story,#full_story').tinymce({
		...
		theme_advanced_buttons3 : "cut,copy,|,paste,pastetext,pasteword,|,search,|,outdent,indent,|,undo,redo,|,link,unlink,anchor,dle_leech,|,dle_upload,image,media,dle_mp,dle_mp3,emotions,dle_spoiler,|,dle_tube,dle_quote,dle_code,dle_hide,dle_break,dle_page",

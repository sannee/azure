...
<table width="100%">
    <tr>
        <td style="padding:2px;">{$lang['b_method']} <select name="comp_method" id="comp_method">{$comp_methods}</select>&nbsp;&nbsp;<input type="button" class="edit" onclick="save(); return false;" value="{$lang['b_save']}" /></td>
    </tr>
</table>
</td>
        <td background="engine/skins/images/tl_rb.gif"><img src="engine/skins/images/tl_rb.gif" width="6" height="1" border="0"></td>
...
<table width="100%">
    <tr>
        <td style="padding:2px;">{$lang['b_restore']} <select name="file" id="file">{$files}</select>&nbsp;&nbsp;<input type="button" class="edit" onclick="dbload(); return false;" value="{$lang['b_load']}" /></td>
    </tr>
</table>
</td>
        <td background="engine/skins/images/tl_rb.gif"><img src="engine/skins/images/tl_rb.gif" width="6" height="1" border="0"></td>
